...
<Card.Root
	class="inset-shadow-xs scale-100 bg-gray-100 grow basis-1/3 max-w-[calc(50%-1rem)] md:basis-1/4 md:max-w-[calc(33%-1rem)] lg:basis-1/5 lg:max-w-[calc(25%-1rem)] transition-transform duration-[30ms] active:scale-[99%]">
